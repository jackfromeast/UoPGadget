let fs = require("fs");
let props = JSON.parse(fs.readFileSync("/home/ubuntu/PPAEG/output/silent-spring/extracted-props/nodejs-lib-extracted-props.json"));
...
fs.writeFileSync("/home/ubuntu/PPAEG/output/silent-spring/undefined-props/gadgets.dynamic-analysis.csv", Array.from(accessed).join("\n"))