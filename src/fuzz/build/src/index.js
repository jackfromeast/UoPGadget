...
function startFuzzer(argv) {
    const fuzzer = new fuzzer_1.Fuzzer(argv.target, argv.dir, argv.exactArtifactPath, argv.rssLimitMb, argv.timeout, argv.regression, argv.onlyAscii, argv.versifier);
    fuzzer.start();
}
require('yargs')
    .scriptName("jsfuzz")
